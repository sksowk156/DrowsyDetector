...
//
//        musicHelper = MusicHelper.getInstance(this@AnalyzesService, this@AnalyzesService)
...
//        // floating view
//        mFloatingView =
//            LayoutInflater.from(this@AnalyzesService).inflate(R.layout.floating_views, null)
//        // 종료 버튼
...
//    ) {
//        // 카메라 및 ML Kit 설정
//        var cameraProviderFuture = ProcessCameraProvider.getInstance(this@AnalyzesService)
//        // 카메라 미리보기 설정
...
////    _sortedParkingLots.observe(this@AnalyzesService) {
////        if (it != null) {
...
////    _sortedShelters.observe(this@AnalyzesService) {
////        if (it != null) {
////            Log.d("whatisthis", it[0].toString())
////        }
////    }
...
////    _sortedRests.observe(this@AnalyzesService) {
////        if (it != null) {
////            Log.d("whatisthis", it[0].toString())
////        }
////    }
...
////    _parkingLots.observe(this@AnalyzesService) {
////        when (it) {
...
////    _shelters.observe(this@AnalyzesService) {
////        when (it) {
////            is ResponseState.Uninitialized -> {}
////            is ResponseState.Loading -> {
...
////    _rests.observe(this@AnalyzesService) {
////        when (it) {
////            is ResponseState.Uninitialized -> {}
////            is ResponseState.Loading -> {
