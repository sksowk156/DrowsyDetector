...
class SttHelperImpl @Inject constructor(
    ...
    override var sttResult = MutableLiveData<String>("")
...
//            showToast("에러 발생 : $message")
     ...
     */
    private val setOfNum1: HashSet<String> = hashSetOf("일본", "일번", "일분", "1분")
    private val setOfNum2: HashSet<String> = hashSetOf("이번", "이분", "2분")
    private val setOfNum3: HashSet<String> = hashSetOf("삼번", "상번", "삼분", "3분")
    private val setOfNum4: HashSet<String> = hashSetOf("4분", "사분")
