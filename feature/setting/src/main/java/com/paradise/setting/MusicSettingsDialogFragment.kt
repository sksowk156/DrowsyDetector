...
import com.paradise.setting.databinding.FragmentMusicSettingsDialogBinding
import kotlinx.coroutines.Job
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.concurrent.TimeUnit

class MusicSettingsDialogFragment(
    private val music: musicItem,
    private val onSaveClick: (music: musicItem) -> Unit,
) : DialogFragment() {

    private var _binding: FragmentMusicSettingsDialogBinding? = null
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            this._binding =
                FragmentMusicSettingsDialogBinding.inflate(LayoutInflater.from(it))
